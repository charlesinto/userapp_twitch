...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var _CityGuard_city_guard__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./CityGuard/city.guard */ "./src/app/CityGuard/city.guard.ts");
    ...
    initializeApp() {
        this.platform.ready().then(() => {
            ...
            if (uid && uid !== null && uid !== 'null') {
                ...
                this.api.post_private('favourite/getByUid', param).subscribe((data) => {
...
let DriverRatingPage = class DriverRatingPage {
    ...
    submit() {
        ...
        this.util.show();
        this.api.post_private('rating/save', param).subscribe((data) => {
            console.log(data);
            this.util.hide();
            if (data && data.status === 200) {
    ...
    submit() {
        ...
        this.api.post_private('rating/save', param).subscribe((data) => {
            ...
            if (data && data.status === 200) {
                ...
                this.api.post_private('products/editList', storeParam).subscribe((stores) => {
    ...
    submit() {
        ...
        this.api.post_private('rating/save', param).subscribe((data) => {
            ...
            if (data && data.status === 200) {
                ...
                this.api.post_private('stores/editByUid', storeParam).subscribe((stores) => {
...
module.exports = __webpack_require__(/*! /Users/charles.onuorah/Downloads/User_app/src/main.ts */"./src/main.ts");
