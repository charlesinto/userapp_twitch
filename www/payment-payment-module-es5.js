...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["payment-payment-module"], {
  ...
  function srcAppPagesPaymentPaymentPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n/*\n  Authors : initappz (Rahul Jograna)\n  Website : https://initappz.com/\n  App Name : ionic 5 groceryee app\n  Created : 10-Sep-2020\n  This App Template Source code is licensed as per the\n  terms found in the Website https://initappz.com/license\n  Copyright and Good Faith Purchasers © 2020-present initappz.\n*/\n.coupones {\n  display: flex;\n  padding: 20px 10px;\n  background: #f3f3f3;\n  margin-top: 10px;\n}\n.coupones .badge {\n  width: 25px;\n  height: 25px;\n}\n.coupones .title {\n  padding: 0px 10px;\n  color: var(--ion-color-primary);\n}\n.billing {\n  padding: 5px 10px;\n}\n.billing .singleRow {\n  display: flex;\n  justify-content: space-between;\n  padding: 10px 0px;\n  border-bottom: 1px dashed lightgray;\n}\n.billing .singleRow .headerTitle {\n  font-size: 0.8rem;\n}\n.billing .singleRow .boldClass {\n  font-weight: bold;\n}\n.billing .singleRow .headerTotal {\n  font-size: 1rem;\n}\n.billing .singleRow .priceTotal {\n  font-size: 1rem;\n}\n.billing .singleRow .price {\n  font-size: 0.8rem;\n}\n.header {\n  background: #f3f3f3;\n  padding: 20px;\n  margin-top: 20px;\n}\n.header .title {\n  font-size: 1rem;\n  font-weight: bold;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    var PaymentPage = /*#__PURE__*/function () {
      ...
      _createClass(PaymentPage, [{
        ...
        value: function getPayments() {
          ...
          this.util.show();
          this.api.get_private('payments/getPaymentList').subscribe(function (data) {
            console.log(data);
        ...
        value: function proceed() {
          ...
          browser.on('loadstop').subscribe(function (event) {
            ...
            if (navUrl.includes('callback')) {
              console.log('close');
              browser.close();
              var _urlItems = new URL(event.url).pathname;
              console.log('--->>', _urlItems.split('/'), _urlItems.split('/').length, _urlItems.split('/')[3]);

              if (_urlItems.split('/').length > 5 && _urlItems.split('/')[3].startsWith('pay_')) {
                var paymentId = _urlItems.split('/')[3];

                console.log('paymentId', paymentId);

                _this3.util.show();

                _this3.api.verifyRazorPayment(paymentId, _this3.razorKey, 'secret_key').then(function (razorResponses) {
                  console.log('razorpayResponse', razorResponses);
                  var razorResponse = JSON.parse(razorResponses.data);
                  console.log('data', razorResponse);

                  _this3.util.hide();

                  if (razorResponse && razorResponse.status === 'authorized' && razorResponse.id === paymentId) {
                    _this3.makeOrder('razorpay', razorResponse.id);
                  }
                }, function (error) {
                  console.log(error);
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    this.util.show();
                    this.api.post_private('orders/save', param).subscribe(function (data) {
                      console.log(data);
